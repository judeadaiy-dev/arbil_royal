...
class AppColors {
  // الألوان الأساسية
  static const Color tealGreen = Color(0xFF1E8C7D);
  static const Color darkOliveGrey = Color(0xFF4E4E3F);
  
  // ألوان التدرج للخلفية
  static const Color skyBlueTop = Color(0xFFCDE7F5);
  static const Color whiteBottom = Color(0xFFFFFFFF);
  
  // ألوان الزجاج - Glassmorphism
  ...
  // ألوان الحالة - ضرورية للأخطاء والنجاح
  ...
  // ألوان شفافة
  static Color tealGreenWithOpacity(double opacity) => tealGreen.withOpacity(opacity);
